 ...
 * app更新
 */
class FlutterAppUpgradePlugin : FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware,
    ...
    override fun onDetachedFromActivityForConfigChanges() {
        with(activityBinding) {
            this?.removeActivityResultListener(this@FlutterAppUpgradePlugin)
        }
    }
